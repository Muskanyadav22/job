...
function Footer() {
  return (
    <footer className="bg-gray-800 text-white py-8 md:py-12 mt-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-8">
          <div>
            <h3 className="font-bold text-base md:text-lg mb-3 md:mb-4">JobFindr</h3>
            <p className="text-gray-400 text-sm">Find your dream job today</p>
          </div>
          <div>
            <h4 className="font-semibold text-sm md:text-base mb-3 md:mb-4">For Job Seekers</h4>
          ...
          <div>
            <h4 className="font-semibold text-sm md:text-base mb-3 md:mb-4">For Employers</h4>
            <ul className="space-y-2 text-gray-400 text-sm">
