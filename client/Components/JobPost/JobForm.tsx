      ...
      case "Summary":
        return (
          <div className="space-y-4">
            ...
            <div className="space-y-3 border-l-4 border-[#7263F3] pl-4">
              <div>
              ...
              <div>
                ...
                <div dangerouslySetInnerHTML={{ __html: jobDescription }} className="prose prose-sm max-w-none" />
              </div>
              <div>
                <p className="text-gray-600 text-sm">Job Type</p>
                <p className="font-semibold">{activeEmploymentTypes.join(", ")}</p>
              </div>
              <div>
                <p className="text-gray-600 text-sm">Salary</p>
                <p className="font-semibold">
                  {salary} {salaryType} {negotiable ? "(Negotiable)" : ""}
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {skills.map((skill, index) => (
                    <span key={index} className="bg-[#7263F3]/10 text-[#7263F3] px-3 py-1 rounded-full text-sm">
                      {skill}
                    </span>
                  ))}
                </div>
